...
#elif (LAB_ID != 0) && (LAB_ID != 2)
# error "No lab code for the selected build configuration (LAB_ID is not in the implemented list). Implemented: LAB00 (LAB_ID=0), LAB02 (LAB_ID=2). Check the active build configuration."
#endif
