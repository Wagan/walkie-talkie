...
#elif (LAB_ID != 0) && (LAB_ID != 2) && (LAB_ID != 3) && (LAB_ID != 5)
# error "No lab code for the selected build configuration (LAB_ID is not in the implemented list). Implemented: LAB00 (LAB_ID=0), LAB02 (LAB_ID=2), LAB03 (LAB_ID=3), LAB05 (LAB_ID=5). Check the active build configuration."
#endif
